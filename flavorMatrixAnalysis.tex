...
\begin{frame}{Every 2024I pT bin passes the stability gate}
\begin{columns}[c,onlytextwidth]
...
\item Independent 1\% truth-fraction changes shift the fitted responses by less than 0.02\% in this conditional model.
\end{itemize}
